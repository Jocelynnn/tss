				...
				<table class="table table-hover table-bordered">
					...
					<s:iterator value="studentList" id="student">
						<tr>
							...
							<td><a
								href="teacherAddStudent.action?studentId=<s:property value='#student.username'/>">添加</a></td>
						</tr>
					</s:iterator>
				...
				<table class="table table-hover table-bordered">
					...
					<s:iterator value="selectedStudentList" id="selectedStudent">
						<tr>
							...
							<td><a
								href="teacherRemoveStudent.action?studentId=<s:property value='#selectedStudent.username'/>">退选</a></td>
						</tr>
					</s:iterator>
